    ...
    for (var i = 0; i < bookmarkList.length; i++) {
        tableContent += `
            <tr>
                ...
                <td><input type="text" id="bmURL`+ i + `" class="form-control stealthInput my-1" value="` + bookmarkList[i]["url"] + `" readonly><div class="invalid-feedback">Site URL is not valid.</div></td>
